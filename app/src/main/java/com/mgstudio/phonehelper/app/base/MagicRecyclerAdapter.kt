...
import com.mgstudio.phonehelper.BR
...
class MagicRecyclerAdapter<LISTENER, DATA>(
    ...
    inner class ViewHolder(val binding: ViewDataBinding, private val clickListener: LISTENER?) :
        ...
        fun setData(itemData: DATA) {
            binding.setVariable(com.mgstudio.phonehelper.BR.item, itemData)
            if (clickListener != null) {
                binding.setVariable(com.mgstudio.phonehelper.BR.clickListener, clickListener)
            }
